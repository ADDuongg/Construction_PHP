                ...
                <div class="modal-body py-2 px-4">
                    ...
                    <div class="d-flex">
                        <div class="mb-3 w-50 me-3">
                            ...
                            <input type="date" name="ngaybatdau" class='form-control' value="" readonly />
                        </div>
                        <div class="mb-3 w-50">
                            <label for="ngayketthuc" class='form-label'>Ngày kết thúc</label>
                            <input type="date" name="ngayketthuc" class='form-control' value="" readonly />
                        </div>
                    </div>
                    <div class="mb-3 ">
                    ...
                    <div class="mb-3">
                        <label for="nguoigiahan" class='form-label'>Người gia hạn : <strong></strong></label>
                    </div>
                </div>
