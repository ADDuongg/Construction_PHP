<div class="modal fade" id="modalUpdateExtendContract">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div style="min-width: 70vh; height: 100%;">
                <div class="modal-header">
                    <div class='d-flex'><h3>Cập nhật gia hạn hợp đồng thi công</h3><h3 class='text-danger'>*</h3></div>
                ...
                <div class="modal-body py-2 px-4">
                    ...
                    <div class="d-flex">
                        <div class="mb-3 w-50 me-3">
                            ...
                            <input readOnly type="date" name="ngaybatdau" class='form-control'  />
                        </div>
                        <div class="mb-3 w-50">
                            <label for="ngayketthuc" class='form-label'>Ngày kết thúc</label>
                            <input readOnly type="date" name="ngayketthuc" class='form-control' />
                        </div>
                    </div>
                    <div class="mb-3 ">
                    ...
                    <!-- <div class="mb-3">
                        <label for="nhanvien_id" class='form-label'>Người gia hạn </label>
                        <input type="text" name='nhanvien_id' class='form-control' />
                    </div> -->
                </div>
